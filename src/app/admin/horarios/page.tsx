...
export default function HorariosPage() {
    ...
    return (
        <div className="admin-page" style={{ maxWidth: "960px", margin: "0 auto" }}>
            ...
            <div className="card rise-2" style={{ padding: "12px 16px", marginBottom: "16px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px", flexWrap: "wrap" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "8px", flexWrap: "wrap" }}>
                    <label style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "12.5px", color: "var(--text-2)", fontWeight: 600 }}>
                        ...
                        <input type="number" min={1} max={50} value={capacityInput}
                            onChange={(e) => {
                                setCapacityInput(e.target.value);
                                const n = parseInt(e.target.value, 10);
                                if (!isNaN(n) && n >= 1 && n <= 50) { setCapacity(n); setDirty(true); setSaved(false); }
                            }}
                            onBlur={() => {
            ...
            {loading ? (
                ...
                <div className="card rise-3" style={{ padding: "16px 16px 16px 0px", overflowX: "auto" }}>
 ...
 .hr-corner { position: sticky; left: 0; z-index: 3; background: var(--card-bg); box-shadow: 6px 0 0 var(--card-bg); }
 .hr-rowhead { font-size: 11.5px; text-align: right; padding-right: 8px; white-space: nowrap; position: sticky; left: 0; z-index: 2; background: var(--card-bg); box-shadow: 6px 0 0 var(--card-bg); }
 ...
 background: rgba(255,255,255,0.015); border: 1px solid rgb(101 132 153);
